...
RotationMatrix RotationMatrix::operator*(const RotationMatrix& other) const
{
    ...
    result.l0.x_Ro = l0.x_Ro*other.l0.x_Ro + l0.y_Phi*other.l1.x_Ro + l0.z_Yaw*other.l2.x_Ro;
    result.l0.y_Phi = l0.x_Ro*other.l0.y_Phi + l0.y_Phi*other.l1.y_Phi + l0.z_Yaw*other.l2.y_Phi;
    result.l0.z_Yaw = l0.x_Ro*other.l0.z_Yaw + l0.y_Phi*other.l1.z_Yaw + l0.z_Yaw*other.l2.z_Yaw;

    result.l1.x_Ro = l1.x_Ro*other.l0.x_Ro + l1.y_Phi*other.l1.x_Ro + l1.z_Yaw*other.l2.x_Ro;
    result.l1.y_Phi = l1.x_Ro*other.l0.y_Phi + l1.y_Phi*other.l1.y_Phi + l1.z_Yaw*other.l2.y_Phi;
    result.l1.z_Yaw = l1.x_Ro*other.l0.z_Yaw + l1.y_Phi*other.l1.z_Yaw + l1.z_Yaw*other.l2.z_Yaw;

    result.l2.x_Ro = l2.x_Ro*other.l0.x_Ro + l2.y_Phi*other.l1.x_Ro + l2.z_Yaw*other.l2.x_Ro;
    result.l2.y_Phi = l2.x_Ro*other.l0.y_Phi + l2.y_Phi*other.l1.y_Phi + l2.z_Yaw*other.l2.y_Phi;
    result.l2.z_Yaw = l2.x_Ro*other.l0.z_Yaw + l2.y_Phi*other.l1.z_Yaw + l2.z_Yaw*other.l2.z_Yaw;
...
{
    return Point(l0.x_Ro*vector.x_Ro + l0.y_Phi*vector.y_Phi + l0.z_Yaw*vector.z_Yaw,
...
RotationMatrix RotationMatrix::getInverse() const
{
    ...
    return RotationMatrix(Point(l0.x_Ro, l1.x_Ro, l2.x_Ro),
			   ...
			   Point(l0.z_Yaw, l1.z_Yaw, l2.z_Yaw));
}
