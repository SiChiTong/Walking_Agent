...
void CommandCreator::moveHingJoint(int index, float angle) {
  if (index == 0)
    ...
    cerr
        << "!!!this index is not available in hingjoint number!!!\n you should select number between (0 -> 7)"
        << endl;
}
...
void CommandCreator::stopAllJoints() {
  strcpy(commandString,
      "(he1 0.0)(he2 0.0)(rae1 0.0)(rae2 0.0)(rae3 0.0)(rae4 0.0)(lae1 0.0)(lae2 0.0)(lae3 0.0)(lae4 0.0)(rle1 0.0)(rle2 0.0)(rle3 0.0)(rle4 0.0)(rle5 0.0)(rle6 0.0)(lle1 0.0)(lle2 0.0)(lle3 0.0)(lle4 0.0)(lle5 0.0)(lle6 0.0)");
}
///===================================
...
void CommandCreator::beam(Point point) {
  sprintf(commandString, "(beam %f %f %f)", point.getX(), point.getY(),
      point.getZ());
}
///===================================
