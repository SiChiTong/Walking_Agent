...
//======================================
bool ServerCommunicationManager::connect(unsigned int port, string hostName) {
  if (connected)
    cerr
        << "ServerCommunicationManager::connect(): Already Connected To Server!"
        << endl;
...
//======================================
char* ServerCommunicationManager::getMsg(){
   return buf;
}
